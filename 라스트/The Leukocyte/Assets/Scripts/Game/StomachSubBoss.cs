...
public class StomachSubBoss : MonoBehaviour {

    public GameObject stomachSubBoss; // 몬스터 게임 오브젝트
    public bool onceOnly = false;
    public GameObject acidManager;
    ...
    private void CheckDeath()
    {
        ...
        {
            stomachSubBoss.SetActive(false);
            if (!onceOnly)
            {
                acidManager.SetActive(false);
