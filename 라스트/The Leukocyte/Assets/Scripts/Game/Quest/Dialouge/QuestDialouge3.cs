...
public class QuestDialouge3 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Quest.queststart[3] == true)
        {
            if (Quest.isclear[3] == false)
            {
    ...
    public void NextSentence()
    {
        ...
        else
        {
            ...
            if (Quest.queststart[3] == true)
            {
                Quest.queststart[3] = false;
                Quest.questplaying[3] = true;
            }
            SceneManager.LoadScene("Town");
            Quest.isclear[3] = true;
            dialogueWindow.gameObject.SetActive(false);
            // 대화가 끝났을때 텍스트 리셋
