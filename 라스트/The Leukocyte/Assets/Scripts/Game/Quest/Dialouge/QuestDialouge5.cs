...
public class QuestDialouge5 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Quest.queststart[5] == true)
        {
            if (Quest.isclear[5] == false)
            {
    ...
    public void NextSentence()
    {
        ...
        else
        {
            ...
            if (Quest.queststart[5] == true)
            {
                Quest.queststart[5] = false;
                Quest.questplaying[5] = true;
            }
            Quest.isclear[5] = true;
            dialogueWindow.gameObject.SetActive(false);
            // 대화가 끝났을때 텍스트 리셋
