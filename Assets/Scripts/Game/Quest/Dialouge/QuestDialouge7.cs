...
public class QuestDialouge7 : MonoBehaviour
{
    ...
    void Update()
    {
        if(Quest.queststart[7] == true)
        {
            if (Quest.isclear[7] == false)
            {
    ...
    public void NextSentence()
    {
        ...
        else
        {
            ...
            if (Quest.queststart[7] == true)
            {
                Quest.queststart[7] = false;
                Quest.questplaying[7] = true;
            }
            Quest.isclear[7] = true;
            dialogueWindow.gameObject.SetActive(false);
            // 대화가 끝났을때 텍스트 리셋
